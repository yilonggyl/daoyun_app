...
var map = {
	...
	"./pages/add-category/add-category.module": [
		...
		"pages-add-category-add-category-module~pages-add-product-add-product-module~pages-category-list-cate~0e834556",
		"common",
		"pages-add-category-add-category-module"
	],
	"./pages/add-course/add-course.module": [
	...
	"./pages/add-product/add-product.module": [
		...
		"pages-add-category-add-category-module~pages-add-product-add-product-module~pages-category-list-cate~0e834556",
		"pages-add-product-add-product-module~pages-in-out-stock-in-out-stock-module~pages-product-desc-produ~6ec74f10",
		"common",
		"pages-add-product-add-product-module"
	],
	...
	"./pages/supplier-list/supplier-list.module": [
...
/* harmony import */ var _services_start_app_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/start-app.service */ "./src/app/services/start-app.service.ts");
...
var routes = [
    ...
    },
    {
        ...
        canActivate: [_services_start_app_service__WEBPACK_IMPORTED_MODULE_2__["StartAppService"]]
    },
    {
        path: 'signup',
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, storage, events) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.events.subscribe('user:created', function (user, time) {
                var u = user;
                _this.user.phone = u.phone;
                _this.user.email = u.email;
                _this.user.shopName = u.shopName;
            });
            var us = _this.storage.get('login', null);
            if (us != null) {
                _this.user.phone = us.phone;
                _this.user.email = us.email;
                _this.user.shopName = us.shopName;
            }
            _this.appPages = [
            ...
            var userStorage = _this.storage.get('user', null);
            if (userStorage == null) {
                var x = [
                    {
                        'shopName': 'admin',
...
/* harmony import */ var _services_app_share_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/app-share.service */ "./src/app/services/app-share.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                _services_app_share_service__WEBPACK_IMPORTED_MODULE_13__["AppShare"]
            ],
...
/***/ "./src/app/services/app-share.service.ts":
/*!***********************************************!*\
  !*** ./src/app/services/app-share.service.ts ***!
  \***********************************************/
/*! exports provided: AppShare */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppShare", function() { return AppShare; });
...
var AppShare = /** @class */ (function () {
    ...
    AppShare.prototype.wxShare = function (scene) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadingCtrl.create({ showBackdrop: false })];
                    case 1:
                        loading = _a.sent();
                        loading.present();
                        try {
    ...
    AppShare.prototype.qqShare = function () {
        return __awaiter(this, void 0, void 0, function () {
            var loading, args;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AppShare.prototype.sendSms = function () {
        var number = '';
        var message = '这是在测试 点到为止-签到管理系统 的短信分享功能！';
        var options = {
    ...
    AppShare = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_0__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_0__["Platform"]])
    ], AppShare);
    return AppShare;
}());
...
/***/ "./src/app/services/start-app.service.ts":
/*!***********************************************!*\
  !*** ./src/app/services/start-app.service.ts ***!
  \***********************************************/
/*! exports provided: StartAppService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StartAppService", function() { return StartAppService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var StartAppService = /** @class */ (function () {
    function StartAppService(localStorageService, router) {
        this.localStorageService = localStorageService;
        this.router = router;
    }
    StartAppService.prototype.canActivate = function (route, state) {
    ...
    StartAppService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_local_storage_service__WEBPACK_IMPORTED_MODULE_2__["LocalStorageService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
    ], StartAppService);
...
module.exports = __webpack_require__(/*! E:\project training\daoyunapp\src\main.ts */"./src/main.ts");
