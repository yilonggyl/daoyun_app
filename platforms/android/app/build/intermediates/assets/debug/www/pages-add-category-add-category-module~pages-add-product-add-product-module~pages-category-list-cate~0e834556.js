(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-add-category-add-category-module~pages-add-product-add-product-module~pages-category-list-cate~0e834556"],{
...
/* harmony import */ var _shared_mock_categories__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/mock.categories */ "./src/app/shared/mock.categories.ts");
...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                c = this.localStorageService.get('Category', _shared_mock_categories__WEBPACK_IMPORTED_MODULE_1__["CATEGORIES"]);
                return [2 /*return*/, {
                        targetUrl: '',
                        result: c,
                        success: true,
    ...
    CategoryService.prototype.insert = function (category) {
        ...
        if (this.isUniqueName(category)) {
            this.getAll().then(function (data) {
                ...
                _this.localStorageService.set('Category', categories);
            });
            return true;
        }
        else {
    ...
    CategoryService.prototype.isUniqueName = function (category) {
        var x = [];
    ...
    CategoryService.prototype.get = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var cat, _i, cat_1, c;
            return __generator(this, function (_a) {
                cat = this.localStorageService.get('Category', _shared_mock_categories__WEBPACK_IMPORTED_MODULE_1__["CATEGORIES"]);
                for (_i = 0, cat_1 = cat; _i < cat_1.length; _i++) {
                    c = cat_1[_i];
                    if (id == c.id) {
                        return [2 /*return*/, {
                                targetUrl: '',
    ...
    CategoryService.prototype.update = function (category) {
        var cat = this.localStorageService.get('Category', _shared_mock_categories__WEBPACK_IMPORTED_MODULE_1__["CATEGORIES"]);
        for (var _i = 0, cat_2 = cat; _i < cat_2.length; _i++) {
            var c = cat_2[_i];
            if (category.id == c.id) {
    ...
    CategoryService.prototype.insertSubCategory = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            var data, cat, maxId, _i, _a, c, _b, _c, c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!this.isUniqueName(category)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.get(category.id)];
                    case 1:
                        data = _d.sent();
                        if (data.success) {
                            cat = data.result;
                            maxId = category.id * 100 + 1;
                            for (_i = 0, _a = cat.children; _i < _a.length; _i++) {
                                c = _a[_i];
                                if (c.id > maxId) {
                                    maxId = c.id;
                                }
                            }
                            for (_b = 0, _c = category.children; _b < _c.length; _b++) {
                                c = _c[_b];
                                c.id = maxId + 1;
                                maxId = c.id;
                                cat.children.push(c);
    ...
    CategoryService.prototype.watchCategory = function () {
...
//# sourceMappingURL=pages-add-category-add-category-module~pages-add-product-add-product-module~pages-category-list-cate~0e834556.js.map